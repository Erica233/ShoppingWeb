            ...
            <ul class="navbar-nav nav-tabs me-auto mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="market.php?Category=Food">Food</a></li>
                        <li><a class="dropdown-item" href="market.php?Category=Clothes">Clothes</a></li>
                        <li><a class="dropdown-item" href="market.php?Category=Groceries">Groceries</a></li>
                    </ul>
                </li>
                <li class="nav-item">
